  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div 
          className="absolute top-60 right-20 w-80 h-80 bg-gradient-to-br from-[#AAD1E0]/40 to-[#7EB1CF]/40 rounded-full blur-3xl floating" 
          style={{ animationDelay: '1s' }}
        ></div>
        <div 
          className="absolute bottom-20 left-1/4 w-64 h-64 bg-gradient-to-br from-[#F8FCFD]/30 to-[#7EB1CF]/30 rounded-full blur-3xl floating" 
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center items-center flex-wrap gap-2 sm:gap-3 md:gap-4 mb-12 fade-in-up">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 luxury-card px-2 sm:px-3 md:px-6 py-1.5 sm:py-2 md:py-3 rounded-full whitespace-nowrap">
              ...
              <span className="font-semibold text-foreground text-xs sm:text-sm md:text-base">300+ Happy Renters</span>
            </div>
          ...
          <p 
            ...
            className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-12 sm:mb-16 max-w-4xl mx-auto leading-relaxed fade-in-up"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-12 sm:mb-16 fade-in-up" style={{ animationDelay: '0.4s' }}>
            <Button 
              size="lg" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto fade-in-up" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="luxury-card p-6 sm:p-8 rounded-3xl group hover:luxury-glow transition-all duration-500 hover:scale-105" style={{ animationDelay: '0.1s' }}>
              <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">💯</div>
            ...
            <div className="luxury-card p-6 sm:p-8 rounded-3xl group hover:luxury-glow transition-all duration-500 hover:scale-105" style={{ animationDelay: '0.2s' }}>
              <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">⚡</div>
