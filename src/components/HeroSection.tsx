...
const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center overflow-hidden pt-20" style={{
    background: 'linear-gradient(135deg, #7EB1CF 0%, #F8FCFD 35%, #AAD1E0 65%, #F8FCFD 100%)'
      ...
      <div className="container mx-auto relative z-10 my-[60px] px-[16px] py-[50px]">
        <div className="max-w-4xl mx-auto text-center px-0">
          ...
          <div className="flex justify-center items-center flex-row gap-2 md:gap-4 mb-12 fade-in-up overflow-x-auto">
            <div className="flex items-center space-x-1 md:space-x-2 luxury-card px-3 md:px-6 py-2 md:py-3 rounded-full whitespace-nowrap">
              <Star className="w-4 h-4 md:w-5 md:h-5 text-yellow-500 fill-current" />
              <span className="font-semibold text-foreground text-sm md:text-base">4.9 Rating</span>
            </div>
            <div className="flex items-center space-x-1 md:space-x-2 luxury-card px-3 md:px-6 py-2 md:py-3 rounded-full whitespace-nowrap">
              <Users className="w-4 h-4 md:w-5 md:h-5 text-primary" />
              <span className="font-semibold text-foreground text-sm md:text-base">300+ Happy Renters</span>
            </div>
            <div className="bg-gradient-to-r from-success to-success/80 text-success-foreground px-3 md:px-6 py-2 md:py-3 rounded-full font-semibold shadow-lg whitespace-nowrap text-sm md:text-base bg-[#dcfce6]">
              100% Free Service
            </div>
          </div>
