      ...
      <section id="how-it-works" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            {/* Section header - Fixed line spacing */}
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-32 left-0 w-full h-1 overflow-hidden">
                <div className="w-full h-full bg-gradient-to-r from-primary via-orange-500 to-emerald-500 opacity-30"></div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
                {steps.map((step, index) => (
                  <div key={step.step} className="relative fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
                    {/* Step card */}
                    <div className="luxury-card rounded-3xl p-8 lg:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 group">
                      {/* Step number - Removed bubble effects */}
                      <div className={`w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center text-white text-2xl lg:text-3xl font-bold mb-8 mx-auto relative z-10 shadow-2xl`}>
                    ...
                    {index < steps.length - 1 && (
                      <div className="lg:hidden flex justify-center my-8">
                        <div className="w-12 h-12 bg-gradient-to-br from-primary to-orange-500 rounded-full flex items-center justify-center shadow-lg">
