          ...
          <div className="max-w-4xl mx-auto text-center fade-in-up">
            ...
            <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto">
              ...
              <div className="flex gap-2 flex-wrap justify-center md:justify-start">
                {categories.map(category => <Badge key={category} variant={selectedCategory === category ? "default" : "outline"} className={`cursor-pointer transition-all duration-300 ${selectedCategory === category ? 'luxury-button text-primary-foreground border-0' : 'hover:bg-primary/10 hover:border-primary/30'}`} onClick={() => setSelectedCategory(category)}>
      ...
      {featuredPosts.length > 0 && <section className="bg-gradient-to-br from-background to-muted/30 my-0 py-[36px]">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {featuredPosts.map((post, index) => <article key={post.id} className={`luxury-card rounded-2xl overflow-hidden group cursor-pointer transition-all duration-500 hover:scale-105 hover:luxury-glow ${index % 2 === 0 ? 'fade-in-left' : 'fade-in-right'}`}>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regularPosts.map((post, index) => <article key={post.id} className={`luxury-card rounded-2xl overflow-hidden group cursor-pointer transition-all duration-500 hover:scale-105 hover:luxury-glow fade-in-up`} style={{
