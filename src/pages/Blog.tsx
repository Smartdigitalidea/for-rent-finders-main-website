  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {featuredPosts.length > 0 && (
        <section className="bg-gradient-to-br from-background to-muted/30 py-8 sm:py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              {featuredPosts.map((post, index) => (
                <Link key={post.id} to={`/blog/${post.id}`}>
                  <article className={`luxury-card rounded-2xl overflow-hidden group cursor-pointer transition-all duration-500 hover:scale-105 hover:luxury-glow ${
